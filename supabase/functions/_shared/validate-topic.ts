// Canonical copy. Mirrored (not imported — Deno edge functions can't reach
// across into src/) at src/lib/validate-topic.ts for instant client-side
// feedback. Keep both in sync when tuning a threshold or adding a rule;
// src/test/validate-topic.test.ts asserts they agree.
//
