...
import { ArrowRight, Compass, Layers, Search, X } from "lucide-react";
                    ...
                    {sections.map((section) => {
                      ...
                      return (
                        <li key={section.system}>
                          ...
                          >
                            <span
                              className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-[var(--r-sm)] text-base leading-none ${
